        ...
        },
        {
          ...
          items: [
            ...
            // This code has been partially generated by an AI.
            {
              label: 'Packagers',
              items: [
                { label: 'packager-nfpm', link: '/plugins/packagers/packager-nfpm/' },
              ],
            },
            {
              label: 'Publishers',
              items: [
                { label: 'publisher-generic-http', link: '/plugins/publishers/publisher-generic-http/' },
                { label: 'publisher-oci', link: '/plugins/publishers/publisher-oci/' },
              ],
            },
            {
              label: 'Providers',
