...
description: Complete .semrel.yaml configuration reference — tag prefix, plugin definitions, updaters, providers, hooks, and monorepo settings for semrel release automation.
---
