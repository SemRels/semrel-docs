...
| | semrel | semantic-release | goreleaser |
|---|---|---|---|
| Runtime | **Keine (statische Binärdatei)** | Node.js + npm | Keine (statische Binärdatei) |
| Auto-SemVer aus Commits | ✅ | ✅ | ❌ tag-basiert |
| Air-gap / Offline-CI | **✅ Nativ** | ❌ | ✅ |
| Supply-Chain-Sicherheit | **Cosign + SBOM + SLSA** | ❌ | Cosign |
| Plugin-Sprache | **Beliebige Binärdatei** | Nur JavaScript | Go (eingebaut) |
| Monorepo | **✅ Kostenlos** | ✅ Kostenlos | ✅ Pro (948 $/Jahr) |

→ [Vollständiger Vergleich: semrel vs semantic-release vs goreleaser vs release-please](/de/guide/comparison/)
