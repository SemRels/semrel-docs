...
<Aside type="note">
  Alle offiziellen Plugins sind Open Source und in der Organisation [SemRels](https://github.com/SemRels) verfügbar. Installiere jedes Plugin mit `semrel plugin install <name>`.
</Aside>
