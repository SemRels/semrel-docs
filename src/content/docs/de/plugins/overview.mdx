...
<picture>
  ...
  <img
    ...
    alt="semrel Plugin-Ökosystem: Provider, Conditions, Analyzer, Generatoren, Updater und Hooks, verbunden mit der Kern-Release-Pipeline"
    width="1024"
    height="1024"
    fetchpriority="high"
...
Entdecke offizielle Plugins im [Plugin Registry](/plugins/registry/), installiere sie mit `semrel plugin install <ref>` und nutze die Anleitung [Plugins verwalten](/plugins/managing/) für Lock-Dateien und Restore-Workflows.
...
<Aside type="tip">
  `semrel plugin install @semrel/github` installiert das Plugin nach `.semrel/plugins/` und aktualisiert `.semrel.lock`. Nackte Namen wie `github` funktionieren nur, wenn der Registry-Eintrag keinen Namespace hat.
</Aside>
