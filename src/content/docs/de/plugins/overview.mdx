...
Die Release-Pipeline von semrel besteht aus eigenständigen Plugin-Executables. Jedes Plugin wird lokal gefunden und als Subprozess ausgeführt – es gibt keine gRPC-Schicht und keinen RPC-Handshake.
