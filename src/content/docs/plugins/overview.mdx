...
description: How the semrel plugin system works — subprocess-based plugins, lifecycle, environment variables, discovery order, and the six plugin categories (provider, condition, analyzer, generator, updater, hook).
---
...
<picture>
  ...
  <img
    ...
    alt="semrel plugin ecosystem showing providers, conditions, analyzers, generators, updaters, and hooks connected to the core release pipeline"
    width="1024"
    height="1024"
    fetchpriority="high"
