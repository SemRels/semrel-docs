...
The registry currently spans plugin categories for providers, conditions, analyzers, generators, updaters, hooks, packagers, and publishers.
...
| `plugins[].versions[].compatibility` | Optional semrel and protocol compatibility hints (`minSemrelVersion`, optional `maxSemrelVersion`, optional `gRPCVersion`) |
