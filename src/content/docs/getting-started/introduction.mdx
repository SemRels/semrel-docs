...
|---|---|---|---|
| Runtime | **None (static binary)** | Node.js + npm | None (static binary) |
| Semantic versioning from commits | ✅ | ✅ | ❌ (tag-based) |
| Air-gap / offline CI | **✅ Native** | ❌ | ✅ |
| Supply-chain security | **Cosign + SBOM + SLSA** | ❌ | Cosign |
| Plugin language | **Any binary** | JavaScript | Go (built-in) |
| Monorepo | **✅ Free** | ✅ Free | ✅ Pro ($948+/yr) |

→ [Full comparison: semrel vs semantic-release vs goreleaser vs release-please](/guide/comparison/)
