...
Each stage can be handled by a separate plugin executable. Install official plugins with commands such as `semrel plugin install @semrel/provider-github`, then configure them in `.semrel.yaml`.
